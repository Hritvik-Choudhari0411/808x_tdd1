...
Google\+Test gives you three different options to solve this problem\+:\hypertarget{md_build__deps_googletest-src_docs_advanced_autotoc_md16}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build__deps_googletest-src_docs_advanced_autotoc_md16}
...
As with assertion macros, you can stream a custom message into {\ttfamily G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}.\hypertarget{md_build__deps_googletest-src_docs_advanced_autotoc_md27}{}\doxysection{Teaching Google\+Test How to Print Your Values}\label{md_build__deps_googletest-src_docs_advanced_autotoc_md27}
...
For more details regarding {\ttfamily Absl\+Stringify()} and its integration with other libraries, see go/abslstringify.\hypertarget{md_build__deps_googletest-src_docs_advanced_autotoc_md28}{}\doxysection{Death Tests}\label{md_build__deps_googletest-src_docs_advanced_autotoc_md28}
...
In particular, if {\ttfamily statement} generates an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$} or {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google\+Test assertions don\textquotesingle{}t abort the process.\hypertarget{md_build__deps_googletest-src_docs_advanced_autotoc_md30}{}\doxysubsection{Death Test Naming}\label{md_build__deps_googletest-src_docs_advanced_autotoc_md30}
