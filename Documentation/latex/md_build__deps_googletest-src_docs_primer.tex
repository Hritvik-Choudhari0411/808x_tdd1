\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md222}{}\doxysection{Introduction\+: Why Google\+Test?}\label{md_build__deps_googletest-src_docs_primer_autotoc_md222}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md224}{}\doxysection{Basic Concepts}\label{md_build__deps_googletest-src_docs_primer_autotoc_md224}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md225}{}\doxysection{Assertions}\label{md_build__deps_googletest-src_docs_primer_autotoc_md225}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md227}{}\doxysection{Invoking the Tests}\label{md_build__deps_googletest-src_docs_primer_autotoc_md227}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md228}{}\doxysection{Writing the main() Function}\label{md_build__deps_googletest-src_docs_primer_autotoc_md228}
...
\{\+: .callout .note\} N\+O\+TE\+: {\ttfamily Parse\+G\+Unit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md229}{}\doxysection{Known Limitations}\label{md_build__deps_googletest-src_docs_primer_autotoc_md229}
