\hypertarget{md_build__deps_googletest-src_googletest_README_autotoc_md391}{}\doxysubsubsection{Setup}\label{md_build__deps_googletest-src_googletest_README_autotoc_md391}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{md_build__deps_googletest-src_googletest_README_autotoc_md392}{}\doxysubsection{Build with C\+Make}\label{md_build__deps_googletest-src_googletest_README_autotoc_md392}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{md_build__deps_googletest-src_googletest_README_autotoc_md394}{}\doxysubsubsection{Incorporating Into An Existing C\+Make Project}\label{md_build__deps_googletest-src_googletest_README_autotoc_md394}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{md_build__deps_googletest-src_googletest_README_autotoc_md398}{}\doxysubsection{Multi-\/threaded Tests}\label{md_build__deps_googletest-src_googletest_README_autotoc_md398}
