\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md222}{}\doxysection{Introduction\+: Why Google\+Test?}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md222}
...
Since Google\+Test is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used J\+Unit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md223}{}\doxysection{Beware of the Nomenclature}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md223}
...
The related term {\itshape Test}, as it is used in Google\+Test, corresponds to the term {\itshape \href{http://glossary.istqb.org/en/search/test\%20case}{\texttt{ Test Case}}} of I\+S\+T\+QB and others.
...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Meaning }&\cellcolor{\tableheadbgcolor}\textbf{ Google\+Test Term }&\cellcolor{\tableheadbgcolor}\textbf{ \href{http://www.istqb.org/}{\texttt{ I\+S\+T\+QB}} Term  }\\\cline{1-3}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md224}{}\doxysection{Basic Concepts}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md224}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md225}{}\doxysection{Assertions}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md225}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the Assertions Reference.\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md226}{}\doxysection{Simple Tests}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md226}
To create a test\+:


\begin{DoxyEnumerate}
\item Use the {\ttfamily \mbox{\hyperlink{test_8cpp_a9ebae24c7a9aeac54ed41797b25483c2}{T\+E\+S\+T()}}} macro to define and name a test function. These are ordinary C++ functions that don\textquotesingle{}t return a value.
...
Google\+Test groups the test results by test suites, so logically related tests should be in the same test suite; in other words, the first argument to their {\ttfamily \mbox{\hyperlink{test_8cpp_a9ebae24c7a9aeac54ed41797b25483c2}{T\+E\+S\+T()}}} should be the same. In the above example, we have two tests, {\ttfamily Handles\+Zero\+Input} and {\ttfamily Handles\+Positive\+Input}, that belong to the same test suite {\ttfamily Factorial\+Test}.
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_same-data-multiple-tests}
...
When using a fixture, use {\ttfamily T\+E\+S\+T\+\_\+\+F()} instead of {\ttfamily \mbox{\hyperlink{test_8cpp_a9ebae24c7a9aeac54ed41797b25483c2}{T\+E\+S\+T()}}} as it allows you to access objects and subroutines in the test fixture\+:
...
Unlike {\ttfamily \mbox{\hyperlink{test_8cpp_a9ebae24c7a9aeac54ed41797b25483c2}{T\+E\+S\+T()}}}, in {\ttfamily T\+E\+S\+T\+\_\+\+F()} the first argument must be the name of the test fixture class. ({\ttfamily \+\_\+F} stands for \char`\"{}\+Fixture\char`\"{}). No test suite name is specified for this macro.
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md227}{}\doxysection{Invoking the Tests}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md227}
{\ttfamily \mbox{\hyperlink{test_8cpp_a9ebae24c7a9aeac54ed41797b25483c2}{T\+E\+S\+T()}}} and {\ttfamily T\+E\+S\+T\+\_\+\+F()} implicitly register their tests with Google\+Test. So, unlike with many other C++ testing frameworks, you don\textquotesingle{}t have to re-\/list all your defined tests in order to run them.
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md228}{}\doxysection{Writing the main() Function}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md228}
...
\{\+: .callout .note\} N\+O\+TE\+: {\ttfamily Parse\+G\+Unit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md229}{}\doxysection{Known Limitations}\label{md__home_mudit_ENPM808x_Week4_cpp-boilerplate-v2_build__deps_googletest-src_docs_primer_autotoc_md229}
