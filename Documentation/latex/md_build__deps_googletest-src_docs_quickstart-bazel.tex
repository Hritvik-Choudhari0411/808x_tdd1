...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md233}{}\doxysection{Create and run a binary}\label{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md233}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md234}{}\doxysection{Next steps}\label{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md234}
